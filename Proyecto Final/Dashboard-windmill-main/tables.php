...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>Proyectos - Windmill</title>
    <link
          ...
          <div class="container grid px-6 mx-auto">
            ...
            >
              <div class="flex items-center">
                ...
                <span>¡Cotiza un proyecto con nosotros!</span>
              </div>
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      <td class="px-4 py-3">
                        <div class="flex items-center text-sm">
                          ...
                          <div>
                            <p class="font-semibold">Salitre Plaza</p>
                            <p class="text-xs text-gray-600 dark:text-gray-400">
                              Bogotá
                            </p>
                          </div>
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      <td class="px-4 py-3">
                        <div class="flex items-center text-sm">
                          ...
                          <div>
                            <p class="font-semibold">Acandí</p>
                            <p class="text-xs text-gray-600 dark:text-gray-400">
                              Villavicencio
                            </p>
                          </div>
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      <td class="px-4 py-3">
                        <div class="flex items-center text-sm">
                          ...
                          <div>
                            <p class="font-semibold">Mallorquin</p>
                            <p class="text-xs text-gray-600 dark:text-gray-400">
                              Barranquilla
                            </p>
                          </div>
