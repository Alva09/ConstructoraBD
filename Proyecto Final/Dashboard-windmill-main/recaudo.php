              ...
              <table class="w-full whitespace-no-wrap">
                <thead>
                  ...
                  >
                    ...
                    <th class="px-4 py-3">Fecha del movimiento</th>
                  </tr>
                </thead>
                  <tbody
                ...
                >
                  <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        <div>
                          <p class="font-semibold">Sebastian Alvarez</p>
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        ...
                        <div>
                          <p class="font-semibold">Esteban Blanco</p>
                          <p class="text-xs text-gray-600 dark:text-gray-400">
                            Cliente
                          </p>
                        </div>
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        <div>
                          <p class="font-semibold">Daniela del Mar</p>
                          <p class="text-xs text-gray-600 dark:text-gray-400">
                            Empresa
                          </p>
                        </div>
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        <div>
                          <p class="font-semibold">Raul Roncador</p>
                          <p class="text-xs text-gray-600 dark:text-gray-400">
                            Cliente
                          </p>
                        </div>
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        <div>
                          <p class="font-semibold">David Plazas</p>
                          <p class="text-xs text-gray-600 dark:text-gray-400">
                            Empresa
                          </p>
                        </div>
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        <div>
                          <p class="font-semibold">Valeria Lugo</p>
                          <p class="text-xs text-gray-600 dark:text-gray-400">
                            Cliente
                          </p>
                        </div>
